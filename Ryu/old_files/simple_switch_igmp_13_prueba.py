...
class SimpleSwitchIgmp13(simple_switch_13.SimpleSwitch13):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._snoop.set_querier_mode(
            dpid=str_to_dpid('0000000000000001'), server_port=4)

    @set_ev_cls(igmplib.IgmpLib, MAIN_DISPATCHER)
	...
	msg_type = req_igmp.msg_type
	address = req_igmp.address
	
	 self.logger.info("packet %s with %s", msg_type, address)
