...
######################################
# Application for the transition scenario SDN with IGMPv2 #
######################################

#Name:        SwitchIGMPv2Client

#Description: Application that manages a switch to be a proxy multicast using IGMPv2 
#            to provide multicast traffic from two providers to different clients in Client mode (C,*)
...
class SwitchIGMPv2Client(app_manager.RyuApp):
    OFP_VERSIONS = [ofproto_v1_3.OFP_VERSION]

    def __init__(self, *args, **kwargs):
        super(SwitchIGMPv2Client, self).__init__(*args, **kwargs)
        self.mac_to_port = {}
        self._to_hosts = {}
        self.serv_to_client = {'1': '5', '2': '5', '3': '6', '4': '6'}
    ...
    def do_report(self, igmp_in, in_port, msg):
        ...
        actions = []
        server = int(self.serv_to_client[str(in_port)])
    ...
    def _packet_in_handler(self, ev):
        ...
        if(igmp_in):    #Check if the packet is IGM
