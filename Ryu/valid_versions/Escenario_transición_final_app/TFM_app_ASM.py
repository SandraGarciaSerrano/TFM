...
#Name:        SwitchIGMPv2ASM

#Description: Application that manages a switch to be a proxy multicast using IGMPv2 
#            to provide multicast traffic from two providers to different clients in ASM mode
...
class SwitchIGMPv2ASM(app_manager.RyuApp):
    OFP_VERSIONS = [ofproto_v1_3.OFP_VERSION]

    def __init__(self, *args, **kwargs):
        super(SwitchIGMPv2ASM, self).__init__(*args, **kwargs)
        self.mac_to_port = {}
        self._to_hosts = {}
    ...
    def do_report_ASM(self, igmp_in, in_port, msg):
    ...
    def _packet_in_handler(self, ev):
        ...
        if(igmp_in):    #Check if the packet is IGMP
            ...
            if(igmp_in.msgtype==0x16): #IGMPv2 report (Join) message
                ...
                self.do_report_ASM(igmp_in, in_port, msg)
