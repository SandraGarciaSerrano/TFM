...
## First version for the basic SDN scenario (only one server and several clients ##

## Developed by Sandra García Serrano ##
...
class SimpleSwitchIGMP13(app_manager.RyuApp):
    ...
    #def del_flow(self, datapath, priority, actions):
     #   ofproto = datapath.ofproto
     #   parser = datapath.ofproto_parser
     #   inst = [parser.OFPInstructionActions(ofproto.OFPIT_APPLY_ACTIONS, actions)]
     #   mod = parser.OFPFlowMod(datapath=datapath, priority=priority, command=ofproto.OFPFC_DELETE, instructions=inst)
