...
######################################
# Application for the global scenario SDN in mode ASM #
######################################

#Name:        SwitchIGMPv3ModeASM
...
class SwitchIGMPv3ModeASM(app_manager.RyuApp):
    OFP_VERSIONS = [ofproto_v1_3.OFP_VERSION]

    def __init__(self, *args, **kwargs):
        super(SwitchIGMPv3ModeASM, self).__init__(*args, **kwargs)
        self.mac_to_port = {}
        self._to_hosts = {}
