...
######################################
# Application for the global scenario SDN with modes #
######################################

#Name:        SwitchIGMPv3Modes
...
#            different modes of the controller choosing by parameters
...
class SwitchIGMPv3Modes(app_manager.RyuApp):
    OFP_VERSIONS = [ofproto_v1_3.OFP_VERSION]

    def __init__(self, *args, **kwargs):
        super(SwitchIGMPv3Modes, self).__init__(*args, **kwargs)
        CONF = cfg.CONF
        CONF.register_opts([
